...
//     index: "01",
//     name: "DevForge",
//     client: "Creative development studio",
//     year: "2026",
//     live: "https://www.devforgebuilds.in/",
//     liveLabel: "devforgebuilds.in",
//     role: "Frontend developer · brand site & interactive systems",
//     summary:
//       "A bold, editorial studio site for a digital product agency — oversized display type, a cursor-reactive SVG diagram, and a numbered, systems-inspired navigation that sets the tone before a single project is shown.",
//     bullets: [
//       "Custom cursor-tracking SVG diagram that redraws its connecting lines as the pointer moves.",
//       "Editorial type system pairing huge display headlines with a monospace, numbered nav.",
//       "High-contrast olive-and-ink palette with a single lime accent used sparingly across CTAs.",
//     ],
//     stack: ["React JS", "Framer Motion", "Tailwind CSS", "Vercel"],
//     image: "/projects/devforge.png",
//     credit: "Live project screenshot",
//     metrics: [
//       { label: "Sections", value: "6" },
//       { label: "Interaction", value: "Cursor-reactive" },
//       { label: "Type scale", value: "Editorial" },
//     ],
//     accent: "lime",
//   },
//   {
...
export const stats = [
  { value: "05", label: "Products shipped", note: "live on custom domains" },
  { value: "12", label: "Technologies", note: "front end → data layer" },
  { value: "2026", label: "B.Sc CS graduation", note: "Gujarat University" },
  { value: "∞", label: "Coffees per deploy", note: "Ahmedabad, IST" },
];
...
export const projects: Project[] = [
  {
    ...
    index: "01",
    name: "Shivanta Homes",
    client: "Premium residential township",
    year: "2026",
    live: "https://shivanta-homes.vercel.app/",
    liveLabel: "shivanta-homes.vercel.app",
    role: "Full-stack developer · website, CMS & deployment",
    summary:
      "A complete digital experience for a premium 3 BHK residential township in Bharuch — combining an animated architectural showcase with property details, enquiries, site-visit booking and a custom content-management dashboard.",
    bullets: [
      "Responsive property showcase with architectural motion, gallery, floor plans, amenities and an embedded location experience.",
      "Secure admin CMS for updating website content, media, enquiries and site-visit requests without editing code.",
      "Production MERN deployment with MongoDB Atlas, Cloudinary media storage, Render API hosting and Vercel frontend delivery.",
    ],
    stack: ["React", "TypeScript", "Node.js", "MongoDB", "Cloudinary", "Vercel"],
    image: "/projects/shivanta-homes.webp",
    credit: "Live project screenshot",
    metrics: [
      { label: "Platform", value: "Full-stack" },
      { label: "Content", value: "Admin CMS" },
